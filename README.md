...
>En este repositorio encontrarás una solución al "Team Challenge" planteado en el archivo `Team_Challenge_ToolBox_I.ipynb`. En otras palabras, incluye una serie de funciones Python para la creación de modelos de machine learning.  
...
>> Esta función recibe como argumentos un dataframe, el nombre de una columna ('target_col') que se refiere a la columna target o objetivo, un umbral de correlación ('umbral_corr') y un valor de p-valor opcional ('pvalue'). Devuelve una lista de columnas numéricas del dataframe cuya correlación con 'target_col' supere 'umbral_corr'. Si se proporciona 'pvalue', solo se incluyen aquellas columnas que superen el test de hipótesis con una significación mayor o igual a 1-pvalue.  
...
👁️ Tanto en el archivo donde se plantea el reto, **'Team_Challenge_ToolBox_I.ipynb'**, como en el archivo python **'toolbox_ML.py'** las funciones están explicadas de forma más extensa.
...
> Sí, las funciones funcionan. Han sido probadas con varios datasets. Para la demostración de su funcionamiento se ha creado el archivo [**"prueba.ipynb"**](https://github.com/MariaRepository/Team-challenge-11/blob/main/prueba.ipynb), donde se cargan varios dataframes para probar las funciones. Dichos dataframes se cargan desde los siguientes archivos:
>
...
### INFORMACIÓN EXTRA:
>Puedes ver los datasets usados en el archivo de prueba en la carpeta [**dataframe**](https://github.com/MariaRepository/Team-challenge-11/tree/main/dataframe).  
>Las imágenes usadas en este archivo y en el archivo de prueba, generadas todas con IA y editadas con paint, se encuentran en la carpeta [**imagenes**](https://github.com/MariaRepository/Team-challenge-11/tree/main/imagenes), junto a otras imágenes que no fueron utilizadas.
