...
>Las imagenes usadas en este archivo y en el archivo de prueba, generadas todas con IA y editadas con paint, están en la carpeta [**imagenes**](https://github.com/MariaRepository/Team-challenge-11/tree/main/imagenes) , donde están además las imagenes que no fueron usadas.
